...
3. MUST write the detailed requirements, implementation plan, and key decisions in the GitHub issue before implementation — the issue is the source of truth for the work
4. MUST implement based on the issue
...
6. MUST include detailed implementation approach, proposed steps, and key decisions in the PR description — important information discussed in chat MUST be persisted in the issue, PR description, or PR comments, NEVER only in chat
