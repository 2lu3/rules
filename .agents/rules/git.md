...
- Explicitly invoking `flow a` counts as explicit permission for the required flow operations, including merging the targeted PR and moving its task to "done".
